...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2026 at 09:44 AM
...
(1, 'System Admin', 'samuduni@gmail.com', '$2y$10$9cuCsstp8iAzVMfbiG2UmefT8HxzcRQKCmEoe9mOPTpfmrF1Ldl6q')
...
E TABLE `payment` (
  ...
  `order_id` int(11) NOT NULL,
  `payment_method` enum('COD','Bank Transfer') DEFAULT NULL,
...
E TABLE `product` (
  ...
  `product_status` enum('Active','Draft','Inactive') NOT NULL DEFAULT 'Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
